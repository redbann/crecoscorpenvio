...
function init(){
    ...
    $.post("../ajax/pagospendientes.php?op=selectprestamos", function(r){ //parametro r son las opciones que devuelve el id
        $("#id_prest").html(r);
...
function listar()
{
	...
	tabla=$('#tbllistado').dataTable(
	{
		...
		"ajax":
				{
					url: '../ajax/pagospendientes.php?op=listar',
...
function guardaryeditar(e)
{
	...
	$.ajax({
		url: "../ajax/pagospendientes.php?op=guardaryeditar",
	    type: "POST",
	    data: formData,
	    contentType: false,
	    processData: false,
...
{
	$.post("../ajax/pagospendientes.php?op=mostrar",{id_pago : id_pago}, function(data, status)
	{
