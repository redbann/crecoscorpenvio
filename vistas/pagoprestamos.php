        ...
        <div class="row">
              <div class="col-md-12">
                  <div class="box">
                    ...
                    <center><h1 class="box-title">PAGOS DE PRÉSTAMOS </h1></center>
                    ...
                    <div class="panel-body" id="formularioregistros">
                        ...
                        <label>Préstamo(*):</label> 
                          ...
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <input type="number" step = ".01" class="form-control" name="monto_mensual" id="monto_mensual" placeholder="Monto mensual" readonly>
                          </div>
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label>Fecha de pago(*):</label>
                            <input type="date" class="form-control" name="fecha_pago" id="fecha_pago"  placeholder="Fecha de pago" readonly>
                          </div>
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label>Fecha límite(*):</label>
                            <input type="date" class="form-control" name="fecha_limite" id="fecha_limite" placeholder="Fecha límite" readonly>
                          </div>
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label>Interés de mora(*):</label>
                            <input type="number" step=".01" class="form-control" name="mora" id="mora" placeholder="Interés de mora" readonly>
                          </div>
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label>Total a pagar(*):</label>
                            <input type="number" step=".01" class="form-control" name="totalpagar" id="totalpagar" placeholder="Total a pagar" readonly>
                          </div>
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label>Fecha registrada(*):</label>
                            <input type="date" class="form-control" name="fecha_reg" id="fecha_reg" placeholder="Fecha registrada" readonly>
                          </div>
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label>Latitud:</label>
                            <input type="text" class="form-control" name="lat" id="lat" placeholder="Latitud" maxlength="200" readonly>
                          </div>
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label>Longitud:</label>
                            <input type="text" class="form-control" name="lng" id="lng" placeholder="Longitud" maxlength="200" readonly>
                          </div>
                         <!--   -->
...
<script type="text/javascript" src="scripts/pagoprestamos.js"></script>
<?php 
}
ob_end_flush();
?>